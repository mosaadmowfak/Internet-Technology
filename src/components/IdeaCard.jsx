  ...
  return (
    <div className="group bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="flex justify-between items-start mb-4">
        <h3 className="text-xl font-bold text-[#1D2B59] group-hover:text-indigo-800 transition-colors">
          {title}
        </h3>

        <span className="text-xs font-semibold text-white bg-[#1D2B59] px-3 py-1 rounded-full">
          @{owner || "unknown"}
        </span>
      </div>
